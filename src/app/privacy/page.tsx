  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-start p-6 bg-slate-950 text-slate-200">
      <div className="w-full max-w-2xl p-8 bg-slate-900/80 border border-slate-800 rounded-2xl shadow-2xl backdrop-blur-md my-8">
        ...
        <p className="text-xs text-slate-400 mb-6">Last updated: August 2026 | Worldwide GDPR & DPPA Compliance</p>

        <div className="space-y-4 text-sm text-slate-300 leading-relaxed">
          <h2 className="text-base font-semibold text-white pt-2">1. Zero-Knowledge Cryptographic Hashing</h2>
          <p>
            To ensure absolute compliance with the Driver&apos;s Privacy Protection Act (DPPA) and international privacy laws, raw license plate strings are transformed using SHA-256 cryptographic hashing with unique server-side environment salts. No raw plate numbers or plain-text PII are ever stored in our database.
          </p>
          ...
          <h2 className="text-base font-semibold text-white pt-2">4. Global Data Rights & Account Deletion (GDPR)</h2>
          <p>
            For international users across the European Union, United Kingdom, and Canada, RoadEcho complies with regional data privacy frameworks. Users maintain absolute Data Subject Rights, including instant self-service account deletion and permanent data record purging via your user dashboard.
          </p>

          <h2 className="text-base font-semibold text-white pt-2">5. Security & Compliance Audit Trails</h2>
          <p>
